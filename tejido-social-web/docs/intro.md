...
**Tejido Social** es un marco abierto y neutral para la organización comunitaria descentralizada. Es una plataforma de documentación construida con Docusaurus que proporciona conocimiento estructurado, definiciones de roles y kits prácticos para que cualquier comunidad o movimiento pueda organizarse efectivamente sin reinventar la rueda.

Importante: **No está vinculado a ningún movimiento político específico, ideología u organización.** Es una infraestructura reutilizable que cualquier causa puede copiar, adaptar y usar libremente.

El nombre "Tejido Social" se refiere al tejido de la sociedad. Un tejido se teje hilo a hilo. Un movimiento se construye persona a persona.

---

## ¿Por Qué Existe Tejido Social?

La mayoría de los movimientos sociales enfrentan los mismos problemas estructurales:

- **Sin inducción clara** — Los nuevos llegan motivados pero no saben qué hacer
- **Conocimiento concentrado** — El conocimiento crítico está en la cabeza de unos pocos fundadores que a menudo están quemados o no disponibles
- **Sin claridad de roles** — Las personas no saben qué se espera de ellas o cómo crecer
- **Cuello de botella centralizado** — Todo requiere aprobación de un pequeño grupo, imposible escalar
- **Sin documentación** — Nada está escrito, todo depende del boca a boca
- **Fragmentación** — Múltiples grupos haciendo cosas similares sin coordinación
- **Agotamiento** — Los organizadores no tienen sistema de apoyo, el bienestar se ignora
- **Compromiso superficial** — Las personas llegan a una protesta, no saben qué sigue, y desaparecen

**Tejido Social resuelve esto proporcionando una arquitectura organizativa prebuild que los movimientos pueden adoptar.**
...
## Los Organismos (Grupos de Trabajo)

Cada Organismo es un equipo autónomo enfocado en un área específica. Operan independientemente pero se coordinan cuando es necesario:

| Organismo | Qué Hace |
|-----------|----------|
| **[Acción Callejera](./organismos/accion-callejera.md)** | Organiza y ejecuta protestas, demostraciones, acciones públicas |
| **[Seguridad y Cuidado](./organismos/seguridad-cuidado.md)** | Protege a las personas: primeros auxilios, desescalada, legales |
| **[Medios y Comunicación](./organismos/medios-comunicacion.md)** | Controla la narrativa: redes, comunicados, medios, diseño |
| **[Educación](./organismos/educacion.md)** | Construye conocimiento: talleres, formación política, capacitación |
| **[Presión Política](./organismos/presion-politica.md)** | Cambia política: cabildeo, peticiones, campañas legislativas |
| **[Bienestar](./organismos/bienestar.md)** | Sustenta emocionalmente: salud mental, arte, cultura, celebración |
| **[Economía Solidaria](./organismos/economia-solidaria.md)** | Construye alternativas: boicots, redes locales, apoyo mutuo |
| **[Apoyo Legal](./organismos/apoyo-legal.md)** | Protege legalmente: capacitación en derechos, observadores, red de abogados |
...
- **[Preguntas Frecuentes](./recursos/preguntas-frecuentes.md)** — respuestas a objeciones comunes
- **[Glosario](./recursos/glosario.md)** — términos clave explicados

---

## Principios Fundamentales

Este marco opera sobre estos principios:

### Autonomía Sobre Aprobación
Cualquiera puede organizar una acción, en cualquier lugar, en cualquier momento — siempre que siga los principios documentados. No se necesita aprobación central. (Inspirado en el modelo BDS global)

### Documentación Sobre Memoria
Todo debe estar escrito. El objetivo es que una persona completamente nueva pueda leer la documentación y tomar acción significativa sin pedir ayuda a nadie.

### Plataforma Sobre Organización
Tejido Social no es una organización que hace cosas. Es una plataforma que permite que otros hagan cosas. El "centro" define principios y proporciona recursos; los "nodos" actúan autónomamente.

### Comunidad Sobre Protesta
El movimiento debe ser más que resistencia. Debe construir alternativas: economía solidaria, ayuda mutua, eventos culturales, apoyo a la salud mental. La gente se queda cuando hay algo a lo que pertenecer, no solo algo contra lo que luchar.

### Progresión Sobre Gatekeeping
La participación es un currículum. Las personas avanzan naturalmente según interés y capacidad. No hay gatekeeping — solo profundidad creciente.
...
**¿Esto es solo para un movimiento específico?**
...
Sí. Ver **CONTRIBUTING.md** en el repositorio. Todo es open-source bajo CC0 (dominio público).
