...
Pasos concretos para tareas frecuentes del trabajo distrital.

- **[Cómo Conformar un Comité Distrital](./conformar-comite-distrital.md)** — de un distrito sin comité a un Comité de Acción Política de Base Distrital constituido y reconocido.
- **[Cómo Organizar una Asamblea Constitutiva](./organizar-asamblea-constitutiva.md)** — plantilla de facilitación para la asamblea fundacional, con su parte formal y su trabajo participativo.
