...
El Concejo Municipal de Montes de Oca tiene siete regidurías propietarias, cada una con su suplencia, repartidas — según lo reportado — entre seis partidos o coaliciones distintos:

- **Unidad Social Cristiana** — dos regidurías propietarias. Este partido también ocupa la alcaldía.
- **La coalición Frente Amplio + Gente Montesoca** (formada para la elección de 2024) — dos regidurías propietarias.
- **Liberación Nacional** — una regiduría propietaria.
- **Somos Montedioca** (coalición electoral entre el Partido Humanista y el PAC) — una regiduría propietaria.
- **En Común** — un partido cantonal, fundado por una persona que anteriormente militó en el Frente Amplio — una regiduría propietaria.

Las cuatro sindicaturas, una por distrito, se reportan así: San Pedro (Frente Amplio), Sabanilla (Unidad Social Cristiana), San Rafael (Unidad Social Cristiana) y Mercedes (Liberación Nacional — sin suplencia, porque ese partido no postuló a nadie para ese puesto).
...
## Presidencia y vicepresidencia del Concejo

La presidencia y la vicepresidencia se eligen cada dos años. Según lo reportado: en un primer período, la presidencia quedó con Liberación Nacional y la vicepresidencia con Unidad Social Cristiana. Más adelante, la presidencia pasó a una persona vinculada al PAC (con el apoyo de una alianza que incluyó a "En Común"), y la vicepresidencia quedó con una persona electa por Unidad Social Cristiana que, se reporta, posteriormente pasó a ser regidora independiente. **El orden exacto de estos períodos no está confirmado con una segunda fuente** — se deja registrado tal como se narró.

## Algunos datos electorales puntuales
...
En la sesión se planteó una inquietud: que un partido de alcance nacional busque expandirse a nivel municipal en varios cantones del país, después de un resultado importante en la elección legislativa más reciente. Este dato proviene de fuentes internas del partido citadas en la sesión, no de una fuente pública verificada — se deja registrado como una inquietud planteada, no como un análisis confirmado, y queda pendiente de profundizar con fuente contrastable.
...
Fuente: Conocimiento de campo — sesión informativa sobre organización municipal (2026-08-28). Pendiente de contraste con TSE y prensa, y de revisión directa por quienes ocupan estos cargos hoy.
